      ...
      <div class="form-col">
        <div class="form-section">
          ...
          <div class="field">
            ...
            <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. Silk Evening Dress" required />
          </div>

          <div class="field">
            <label for="description">Description <span class="req">*</span></label>
            <textarea id="description" name="description" rows="5" placeholder="Describe the product — material, fit, care instructions..." required>{{ old('description') }}</textarea>
          </div>
          ...
          <div class="field-row">
            ...
            <div class="field">
              ...
              <input type="number" id="original_price" name="original_price" value="{{ old('original_price') }}" placeholder="0.00" min="0" step="0.01" />
            </div>
          </div>
          ...
          <div class="field-row">
            ...
            <div class="field">
              ...
              <input type="number" id="stock" name="stock" value="{{ old('stock') }}" placeholder="0" min="0" required />
            </div>
          </div>
